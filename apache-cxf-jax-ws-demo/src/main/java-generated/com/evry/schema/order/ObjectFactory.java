 ...
 * generated in the com.evry.schema.order package. 
...
public class ObjectFactory {
    ...
    private final static QName _OrderInquiryResponse_QNAME = new QName("http://www.evry.com/schema/Order", "orderInquiryResponse");
    private final static QName _OrderInquiry_QNAME = new QName("http://www.evry.com/schema/Order", "orderInquiry");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.evry.schema.order
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.evry.com/schema/Order", name = "orderInquiryResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.evry.com/schema/Order", name = "orderInquiry")
